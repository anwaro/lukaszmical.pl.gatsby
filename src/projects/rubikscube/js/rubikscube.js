...
const wallA = [faceA, createWall(vertex1, vertex3, colors.blue, 0), new Neighbor(4, 5, 3, 1, 2)];
const wallB = [faceB, createWall(vertex2, vertex7, colors.green, 1), new Neighbor(4, 5, 0, 2, 3)];
const wallC = [faceC, createWall(vertex6, vertex8, colors.orange, 2), new Neighbor(4, 5, 1, 3, 0)];
const wallD = [faceD, createWall(vertex5, vertex4, colors.red, 3), new Neighbor(4, 5, 2, 0, 1)];
const wallE = [faceE, createWall(vertex5, vertex2, colors.white, 4), new Neighbor(2, 0, 3, 1, 5)];
const wallF = [faceF, createWall(vertex4, vertex7, colors.yellow, 5), new Neighbor(0, 2, 3, 1, 4)];
...
function Cube(walls) {
    ...
    this.distance = function (point) {
        ...
        const index = faceNorm.normal.z < 0
    ...
    this.pointInideFace = function (face, point) {
        ...
        let sum = this.lineIntersection(face.v1.ctxPos(), face.v2.ctxPos(), linePoint1, linePoint2);
