...
$$StayAlive = new function () {
    const isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Phone/i.test(navigator.userAgent);
    let canvas,
        ctx,
        game,
        mouseX = 100,
    ...
    function randomPossition() {
        const b = Math.min(canvasHeight, canvasWidth) / Math.max(canvasHeight, canvasWidth) * 0.5,
            i = Math.random();
